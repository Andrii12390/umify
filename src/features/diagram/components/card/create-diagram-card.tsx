...
export const CreateDiagramCard = () => (
  <CreateDiagramPopup>
    <Button className="bg-card group border-muted-foreground/25 hover:border-primary hover:bg-primary/5 relative flex h-50 w-55 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-lg border-2 border-dashed p-6 md:h-55 md:w-60">
